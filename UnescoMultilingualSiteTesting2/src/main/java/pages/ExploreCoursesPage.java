...
public class ExploreCoursesPage {
	...
	public ExploreCoursesPage(WebDriver driver) //to maintain the same driver across various classes, this driver passed in this constructor will be coming from other test classe file(s)
